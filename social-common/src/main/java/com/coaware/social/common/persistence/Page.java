...
public class Page<T> {
	...
	public String toString() {
		...
		if (pageNo == first) {// 如果是首页
			sb.append("<div class=\"pages\"><a href=\"javascript:void(0)\" class=\"pre\">&lt; 前一页</a>");
			//sb.append("<li class=\"disabled\"><a href=\"javascript:\">&#171; 上一页</a></li>\n");
		} else {
			sb.append("<div class=\"pages\"><a href=\"javascript:void(0)\" class=\"pre\" onclick=\""+funcName+"("+prev+","+pageSize+",'"+funcParam+"');\">&lt; 前一页</a>");
		...
		if (begin > first) {
			...
			for (i = first; i < first + slider && i < begin; i++) {
				sb.append("<a href=\"javascript:void(0)\"  onclick=\""+funcName+"("+i+","+pageSize+",'"+funcParam+"');\">"+ (i + 1 - first) + "</a>");
		...
		for (int i = begin; i <= end; i++) {
			if (i == pageNo) {
				sb.append("<a href=\"javascript:void(0)\" class=\"dq\">"+ (i + 1 - first) + "</a>");
		...
		if (pageNo == last) {
			sb.append("<a href=\"javascript:void(0)\" class=\"next\">后一页 &gt;</a></div>");
			//sb.append("<li class=\"disabled\"><a href=\"javascript:\">下一页 &#187;</a></li>\n");
		} else {
			sb.append("<a href=\"javascript:void(0)\" class=\"next\"  onclick=\""+funcName+"("+next+","+pageSize+",'"+funcParam+"');\">后一页 &gt;</a></div>");
			//sb.append("<li><a href=\"javascript:\" onclick=\""+funcName+"("+next+","+pageSize+",'"+funcParam+"');\">"
					//+ "下一页 &#187;</a></li>\n");
		}
		sb.append("<div class=\"fl\">显示 "+((pageNo-1)*pageSize+1)+"到 "+pageNo*pageSize+"项，共 " + count + "项</div>");
