...
tt.i18Len = "{0}最少要输入{1}个字符，你还需要输入{2}个字符!";
...
tt.i18Mobile = "{0}看起来不像个手机号码!<br>合法的格式形如：13912345678";
...
tt.moveToPos = function(srcE, targetE) {
	...
	var top = targetpostion.b - 2;
	var left = targetpostion.l - 1;
...
tt.VF = tt.C.ext({
	init : function() {
		...
		this.mobile = new tt.RV().set(/^[1][34578][0-9]{9}$/).setI18(tt.i18Mobile);
